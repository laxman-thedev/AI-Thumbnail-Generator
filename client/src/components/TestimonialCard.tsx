...
/**
 * TestimonialCard - Displays a single user testimonial with avatar, name,
 * verified badge, handle, and quote. Uses staggered spring animation
 * based on the card index for a cascading entrance effect.
 */
export default function TestimonialCard({ testimonial, index }: TestimonialCardProps) {
    return (
        ...
        >
            {/* User info: avatar, name with verified badge, and handle */}
            ...
            {/* Testimonial quote, clamped to 2 lines */}
